...
class TablePerClassInheritanceTest: AbstractDataJpaTest() {

    @Autowired
    private lateinit var cardRepo: TablePerClassCreditCardRepository

    @Autowired
    private lateinit var accountRepo: TablePerClassBankAccountRepository
