...
import io.github.debop.springboot.webmvc.domain.repository.UserRepository
...
class DatabaseInitializer(
    ...
    override fun run(vararg args: String) {
        ...
        articleRepository.saveAll(listOf(reactorArticle, spring5Article, springKotlinArticle))
    }
}